...
def encode(output_f: str, input_f: str, table_num: int):
    input_file = f"Images/{input_f}bmp"
...
class JPEGFileReader:
    ...
    def read_int(self, size):
        ...
        if bin_num[0] == '1':
            return self.__binary_to_int(bin_num)
        else:
            return self.__binary_to_int(binstr_flip(bin_num)) * -1
    ...
    def __read_uint(self, size):
        ...
        return self.__binary_to_int(self.__read_str(size))
    ...
    def __binary_to_int(self, bin_num):
...
def decoder(output_filename: str, input_filename: str, table_num: int, size_f: int):
